...
(function($){
    ...
    $.fn.toObject = function(options) {
        ...
        switch (settings.mode) {
            case 'first':
                obj = form2object(this.get(0), settings.delimiter, settings.skipEmpty, settings.nodeCallback);
                break;
            case 'all':
                this.each(function() {
                ...
                break;
            case 'combine':
                obj = form2object(Array.prototype.slice.call(this), settings.delimiter, settings.skipEmpty, settings.nodeCallback);
                break;
            default:
                obj = undefined;
                break;
